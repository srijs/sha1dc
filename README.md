...
SHA-1, and slows down hashing by 15% to 26%, depending on the machine.
...
| `sha1dc` (this crate)        |  2404 (82%) |          1387 (74%) |  1375 (85%) |
...
what detection costs: 15% to 26%, depending on the machine.
