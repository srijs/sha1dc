...
SHA-1, and slows down hashing by 18% to 26%, depending on the machine.
...
|------------------------------|------------:|--------------------:|------------:|
| [`sha1`] 0.11.0              | 2981 (100%) |         1789 (100%) | 1616 (100%) |
| `sha1dc` (this crate)        |  2443 (82%) |          1317 (74%) |  1313 (81%) |
| [`sha1-checked`] 0.11.0-rc.0 |   852 (29%) |           500 (28%) |   459 (28%) |
...
what detection costs: 18% to 26%, depending on the machine.
