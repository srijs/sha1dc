...
|------------------------------|------------:|--------------------:|------------:|
| [`sha1`] 0.11.0              | 2987 (100%) |         1876 (100%) | 1616 (100%) |
| `sha1dc` (this crate)        |  2443 (82%) |          1331 (71%) |  1301 (80%) |
| [`sha1-checked`] 0.11.0-rc.0 |   850 (28%) |           525 (28%) |   454 (28%) |
...
what detection costs: 18% to 29%, depending on the machine.
